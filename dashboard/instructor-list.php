                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table  datanew">
                                ...
                                <tbody>
                                    <?php
                                          $selectQuery = "SELECT * FROM `user_master` WHERE `role` = '2' ";
                                    ...
                                    <tr>                
                                        <td class="productimgname">
                                            <a href="javascript:void(0);" class="product-img">
                                                <img src="../<?php echo $row["user_profile_photo"];?>" alt="product">
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            <div
                                                ...
                                                <input disabled type="checkbox" id="user1" class="check" <?php echo ($row["isActive"] == 1)? "checked":"";?>>
